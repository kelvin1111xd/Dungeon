...
PumpkinDude::PumpkinDude()
{
	whatIsThis = "PumpkinDude";
	texture =
	{
		{
			QPixmap(".\\Texture\\Entity\\pumpkin_dude_idle_anim_f0.png").scaled(64, 92, Qt::KeepAspectRatio),
			QPixmap(".\\Texture\\Entity\\pumpkin_dude_idle_anim_f1.png").scaled(64, 92, Qt::KeepAspectRatio),
			QPixmap(".\\Texture\\Entity\\pumpkin_dude_idle_anim_f2.png").scaled(64, 92, Qt::KeepAspectRatio),
			QPixmap(".\\Texture\\Entity\\pumpkin_dude_idle_anim_f3.png").scaled(64, 92, Qt::KeepAspectRatio),
		},
		{
			QPixmap(".\\Texture\\Entity\\pumpkin_dude_run_anim_f0.png").scaled(64, 92, Qt::KeepAspectRatio),
			QPixmap(".\\Texture\\Entity\\pumpkin_dude_run_anim_f1.png").scaled(64, 92, Qt::KeepAspectRatio),
			QPixmap(".\\Texture\\Entity\\pumpkin_dude_run_anim_f2.png").scaled(64, 92, Qt::KeepAspectRatio),
			QPixmap(".\\Texture\\Entity\\pumpkin_dude_run_anim_f3.png").scaled(64, 92, Qt::KeepAspectRatio),
		},
		QPixmap(".\\Texture\\Entity\\pumpkin_dude_hit.png").scaled(64, 92, Qt::KeepAspectRatio)
	};
